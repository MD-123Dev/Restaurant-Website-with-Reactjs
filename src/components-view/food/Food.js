    ...
    return (
        <div>
            <div className=" sty-card" style={{width:'260px',height:300}}>
                <img className="sty-img" src={ props.image } style={{width:'260px',height:'200px'}} alt="" ref = {hide} onMouseOver={ hideCard  } />
                 <div ref={show} onMouseOut={ showCard  } className="sty-hide" style={{display:'none',width:'260px',height:'200px'}}>
